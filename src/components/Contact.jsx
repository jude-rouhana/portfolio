...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceId = 'service_b8x6dgi' // Replace with your service ID
      const templateId = 'template_ywy32zf' // Replace with your template ID
      const publicKey = 'DEVcfMoSMdqumXQr8' // Replace with your public key
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/jude-rouhana/',
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              <div>
                ...
                {/* <p className="text-contrast-gray leading-relaxed mb-8">
              ...
              <div className="space-y-4">
                ...
                {/* <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-sm font-medium text-contrast-gray">Availability</div>
                    <div className="text-contrast">Open to opportunities</div>
                  </div>
                </div> */}
              </div>
